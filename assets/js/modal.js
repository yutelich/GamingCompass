...
const GCModal = (function () {
  ...
  function _showCodeResult(code) {
    _open(`
      ...
      <div style="text-align:center;margin:0.75rem 0 1rem">
        <a href="https://trakteer.id/yudith2/tip" target="_blank" rel="noopener"
           style="display:inline-flex;align-items:center;gap:8px;color:#04B7A6;font-size:0.82rem;font-weight:600;text-decoration:none;opacity:0.85">
          <img src="https://trakteer.id/images/mix/coffee.png" width="16" height="16" alt="">
          Suka guide ini? Dukung di Trakteer ☕
        </a>
      </div>
